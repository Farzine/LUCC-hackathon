  ...
  return (
    <div className="flex  h-screen w-screen justify-center items-center">
      ...
      <div className="w-1/2 h-screen flex flex-col justify-center items-center">
        ...
        <h2 className="font-extralight  space-x-4 text-xl">
        ...
        <form className="my-10" onSubmit={handleSubmit}>
          ...
          <LabelInputContainer className="mb-4">
            ...
            <Input
              required
              id="email"
              placeholder="xyz12@student.sust.edu"
              type="email"
              value={email}
          ...
          <div className="flex justify-center w-full mb-4 ">
            <Button
              ...
              className="px-8 w-full py-2 text-xl rounded-md bg-customRed  text-white font-bold transition duration-200 hover:bg-red-600 hover:shadow-lg   "
            >
              Login
            </Button>
          </div>
          ...
          <div className="flex justify-center mb-4">
            <Label onClick={handleRegister} htmlFor="password">
              Don&apos;t have any account ?{" "}
              <b className="hover:cursor-pointer hover:underline">Register</b>
            </Label>
          </div>
        </form>
      </div>
